...
head = node(22, None) # Create a node with data 1
print(head.data,'is pushed')
head = push(head, 10) # Push 2 onto the stack
print(head.data,'is pushed')
head = push(head, 12) # Push 3 onto the stack
print(head.data,'is pushed')
head = push(head, 2) # Push 4 onto the stack
print(head.data,'is pushed')
